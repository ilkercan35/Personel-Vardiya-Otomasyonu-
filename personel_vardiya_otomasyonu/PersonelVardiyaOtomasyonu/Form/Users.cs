...
namespace PersonelVardiyaOtomasyonu
{
    public partial class Users : Form
    {
        ...
        {
            if (cb_roles.Text != "" && txt_identificationNumber.Text != "" && txt_name.Text != "" && txt_surname.Text != "" && txt_password.Text != "" && txt_address.Text != "" && txt_email.Text != "" && txt_phoneNumber.Text != "" && cb_leave_day_1.Text != "" && cb_leave_day_2.Text != "")
			{
                if (!_userDal.CheckByIdentificationNumber(txt_identificationNumber.Text))
                {
                    User user = new User
                    {
						...
						leave_day_1 = cb_leave_day_1.Text,
						leave_day_2 = cb_leave_day_2.Text,
        ...
        private void dgv_users_CellClick(object sender, DataGridViewCellEventArgs e)
        {
			...
			cb_leave_day_1.Text = dgv_users.CurrentRow.Cells[11].Value.ToString();
			cb_leave_day_2.Text = dgv_users.CurrentRow.Cells[12].Value.ToString();
		}
        ...
        public void Clear()
        {
			...
			cb_leave_day_1.SelectedIndex = -1;
			cb_leave_day_2.SelectedIndex = -1;
		}
